...
export const Navigation = () => {
  ...
  return (
    <>
      {/* Mobile Hamburger */}
      <div className={`fixed top-0 left-0 right-0 h-16 z-40 md:hidden transition-all duration-300 ${
      ...
      {/* Desktop Menu */}
      <nav className={`fixed top-0 left-0 right-0 p-6 z-30 hidden md:block transition-all duration-500 ${
        isScrolled ? 'bg-gradient-to-b from-white/5 via-white/0 backdrop-blur-lg' : 'bg-transparent'
      }`}>
